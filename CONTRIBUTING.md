...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad.com.git
cd blackroad.com

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad.com.git
